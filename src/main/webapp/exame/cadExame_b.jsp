			...
			<div class="col-sm p-0">
				<div style="margin-bottom: 10px">
					...
					<div style="margin-bottom: -40px">
						<h4 style="color: #3f8c97">Exames</h4>
					</div>

					<div class="d-flex justify-content-end"">
						<s:url action="novoExame" var="novo" />
						<a href="${novo}" class="btn btn text-white "
							style="background-color: #3f8c97"> <svg
								style="padding: 2px; margin-right: 8px"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="24" height="24">
						<path fill-rule="evenodd" fill="rgb(255,255,255)"
									d="M5 2.5a.5.5 0 00-.5.5v18a.5.5 0 00.5.5h14a.5.5 0 00.5-.5V8.5h-4a2 2 0 01-2-2v-4H5zm10 0v4a.5.5 0 00.5.5h4a.5.5 0 00-.146-.336l-4.018-4.018A.5.5 0 0015 2.5zM3 3a2 2 0 012-2h9.982a2 2 0 011.414.586l4.018 4.018A2 2 0 0121 7.018V21a2 2 0 01-2 2H5a2 2 0 01-2-2V3z"></path></svg>
				...
				<s:form action="/filtrarExames.action">
					<div class="input-group">
						...
						<button class="btn btn-primary" type="submit" style="background-color: #3f8c97; border: none">
