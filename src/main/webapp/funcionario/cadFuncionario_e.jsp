			...
			<div class="card mt-5">
				<div class="card-header">
					<div class="row">
						<div class="col-sm-5">
							<s:url action="todosFuncionarios" var="todos" />
							<a href="${todos}" class="btn btn-warning text-white">Funcionários</a>
						</div>

						<div class="col-sm">
							<h5 class="card-title" style="color: #3f8c97">Editar Funcionário</h5>
						</div>
					</div>
				</div>
				...
				<div class="card-footer">
					<div class="form-row">
						<button style="background-color: #3f8c97; border: none"class="btn text-white col-sm-4 offset-sm-1">
							Salvar</button>
						<button type="reset"
